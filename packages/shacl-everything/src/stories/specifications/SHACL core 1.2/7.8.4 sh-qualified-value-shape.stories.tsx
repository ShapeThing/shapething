...
export default {
  title:
    "Specifications/SHACL core 1.2/7. Core Constraint Components/7.8 Shape-based Constraint Components/7.8.4 sh:qualifiedValueShape, sh:qualifiedMinCount, sh:qualifiedMaxCount",
