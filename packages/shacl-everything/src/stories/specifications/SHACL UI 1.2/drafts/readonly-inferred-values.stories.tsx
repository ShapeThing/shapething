...
// lives outside "Specifications/SHACL UI 1.2/" until/unless it's formalized. Existing triples also present in
...
export default {
  title: "Specifications/SHACL UI 1.2/drafts/Read-only inferred values #1180",
