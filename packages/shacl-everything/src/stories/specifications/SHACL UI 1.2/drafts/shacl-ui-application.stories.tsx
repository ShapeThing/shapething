...
// "Specifications/SHACL UI 1.2/" until that section is actually assigned a number in the spec.
type Story = StoryObj<ShaclUIApplicationProps>;

export default {
  title: "Specifications/SHACL UI 1.2/drafts/SHACL UI Application #1118",
