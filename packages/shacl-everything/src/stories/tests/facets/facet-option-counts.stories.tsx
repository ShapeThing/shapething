...
export default {
  title: "Tests/Facets/Option counts",
...
// own root-shape picker, which resolves to the very same widget) shows a count next to each
...
// filled in, a count shows how many current target instances have a value inside [min, max].
...
// other facet (facets/compileFilter.ts's compileFilter), not a static tally
