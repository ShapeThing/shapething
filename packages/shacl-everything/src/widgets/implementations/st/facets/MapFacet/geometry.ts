 ...
 * value (see facets/filterShape.ts) - unwraps a MultiPolygon into one Polygon feature per member,
 ...
 * st:withinArea literal (see facets/filterShape.ts) - undefined once nothing is drawn
