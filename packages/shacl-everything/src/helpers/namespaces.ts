...
/** SHACL namespace */
export function sh<T extends string>(localName: T): NamedNode<`http://www.w3.org/ns/shacl#${T}`> {
...
export const st: NamespaceBuilder<string> = namespace("http://shapething/", {
  factory,
});
...
/** WGS84 Geo namespace */
export const geo: NamespaceBuilder<string> = namespace("http://www.w3.org/2003/01/geo/wgs84_pos#", {
  factory,
});
