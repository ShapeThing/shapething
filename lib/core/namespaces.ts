...
export const dce: NamespaceBuilder<string> = namespace('http://purl.org/dc/elements/1.1/')

/** Dublin Core namespace */
export const dct: NamespaceBuilder<string> = namespace('http://purl.org/dc/terms/1.1/')
...
/** Genid */
export const genid: NamespaceBuilder<string> = namespace('https://shacl-renderer.shapething.com/.well-known/genid/')

export const foaf: NamespaceBuilder<string> = namespace('http://xmlns.com/foaf/0.1/')
...
export const geo: NamespaceBuilder<string> = namespace('http://www.opengis.net/ont/geosparql#')
